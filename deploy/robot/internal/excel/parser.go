...
var ruleSheets = []struct {
	...
	{Name: "Velocista_Registro", Category: "Seguidor de línea velocista", Type: RuleSheetTypeRegistration},
	...
	{Name: "Futbol_Registro", Category: "Fútbol", Type: RuleSheetTypeRegistration},
	{Name: "Futbol_Restricciones", Category: "Fútbol", Type: RuleSheetTypeRestriction},
}
