    ...
    function initEquipoDetalle(outlet, params) {
        ...
        w.CRApi.getCatalogTeam(id)
            .then(function (data) {
                ...
                var fmt =
                    w.CRApiEquiposRegistro && w.CRApiEquiposRegistro.normalizeMember
                        ? function (m) {
                              return w.CRApiEquiposRegistro.normalizeMember(m);
                          }
                        : function (m) {
                              return m;
                          };
                ...
                if (members.length > 0 && miembros.indexOf('cr-catalog-member-card') === -1) {
                    miembros =
                        '<p class="cr-catalog-msg mt-4">Hay integrantes en el servidor pero sin nombre legible; revisa el registro en admin.</p>';
                }
                host.innerHTML =
